...
public class PrinterFunctions {
	...
	public static native int PrintPDF417Code(String portName, int portSettings, int Columns, int Rows, int Width,
			int Height, int CorrectionLevel, String dArray);

	public static native int PrintQrCode(String portName, int portSettings, int n, int mod, int size, int version,
			String dArray);
	...
	public static native int PrintCode39(String portName, int portSettings, String barcodeData, int option, int height,
			int width);

	public static native int PrintCode93(String portName, int portSettings, String barcodeData, int option, int height,
			int width);

	public static native int PrintCodeITF(String portName, int portSettings, String barcodeData, int option, int height,
			int width);

	public static native int PrintCode128(String portName, int portSettings, String barcodeData, int option, int height,
			int width);
	...
	public static native int PrintTextKanji(String portName, int portSettings, int underline, int invertColor,
			int emphasized, int upsideDown, int heightExpansion, int widthExpansion, int leftMargin, int alignment,
			String textData);
	...
	// --------------------------
	public static native int PrintBarCode(String portName, int portSettings, String barcodeData, int option, int height,
			int width, int alignment, int mod);
	...
	public static native int SetPrintingAreaInPageMode(String portName, int portSettings, int X, int Y, int Width,
			int Height);
