...
public class Main extends Activity {
	...
	public void PortDiscovery(View view) {
		...
		new AlertDialog.Builder(view.getContext()).setTitle("Please Input IP Address or Port Name")
				.setView(editPortName).setPositiveButton("OK", new DialogInterface.OnClickListener() {
						...
						if (portName.length() > 0) {
							...
							dialog2.setPositiveButton("OK", new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
									...
									// --------------------------
									// ��ܨϥΪ�����
									if (portName.substring(0, 3).equals("LAN")
											|| portName.substring(0, 4).equals("WIFI")) {
										...
										dialog3.setPositiveButton("OK", new DialogInterface.OnClickListener() {
											...
											public void onClick(DialogInterface dialog, int which) {
												...
												if (isLAN) {
													resOpen = PrinterFunctionsLAN.PortDiscovery(Main.portName,
															Main.portSettings);
												} else {
													resOpen = PrinterFunctions.PortDiscovery(Main.portName,
															Main.portSettings);
												}
												if (resOpen == 0) {
										...
										if (isLAN) {
											resOpen2 = PrinterFunctionsLAN.PortDiscovery(Main.portName,
													Main.portSettings);
										} else {
	...
	public void Help_main(View view) {
		String helpString = "<body>" + "<MainTitle>int PortDiscovery(String portName,int portSettings)</MainTitle><br/>"
				+ "<br/>" + "<SubTitle><ColorBlue>IF USING COM PORT</ColorBlue></SubTitle><br/>"
				+ "<SubTitle>Port Name Parameters</SubTitle><br/>" + "<StandardItalic>COM:3</StandardItalic><br/>"
				+ "Enter your COM port number<br/>" + "<SubTitle>Port Settings Parameters</SubTitle><br/>"
				+ "<StandardItalic>115200</StandardItalic><br/>" + "Enter your baudrate<br/>" + "<br/>"
				...
				+ "<SubTitle>Port Settings Parameters</SubTitle><br/>" + "Default value is 0<br/>" + "<br/>"
				+ "<SubTitle><ColorBlue>IF USING LAN</ColorBlue></SubTitle><br/>"
				+ "<SubTitle>Port Name Parameters</SubTitle><br/>"
				+ "<StandardItalic>LAN:192.168.2.11</StandardItalic><br/>" + "Enter your IP address<br/>"
				+ "<SubTitle>Port Settings Parameters</SubTitle><br/>" + "<StandardItalic>9100</StandardItalic><br/>"
				+ "Enter your port number<br/>" + "<br/>"
				+ "<SubTitle><ColorBlue>IF USING WIFI</ColorBlue></SubTitle><br/>"
				+ "<SubTitle>Port Name Parameters</SubTitle><br/>"
				+ "<StandardItalic>WIFI:192.168.2.22</StandardItalic><br/>" + "Enter your IP address<br/>"
				+ "<SubTitle>Port Settings Parameters</SubTitle><br/>" + "<StandardItalic>9100</StandardItalic><br/>"
				+ "Enter your port number<br/>" + "<br/>" + "<br/>" + "<br/>"
				+ "<StandardItalic>Version Number 1.7</StandardItalic><br/>" + "</body></html>";
